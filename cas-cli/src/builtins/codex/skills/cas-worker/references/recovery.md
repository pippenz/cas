...
2. **Before any escalation, drain your inbox** with `mcp__cs__coordination action=queue_poll`. If a pending supervisor message says the branch was merged or requests more changes, follow it and do not send a stale merge request.
