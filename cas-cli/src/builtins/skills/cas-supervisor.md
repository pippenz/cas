...
- **Tier every spawn — never fleet-default.** Explicit `model=`/`effort=` every spawn (light / standard floor / heavy / frontier). Details: [model-selection.md](cas-supervisor/references/model-selection.md).
