...
cas__coordination action=spawn_workers count=1 isolate=true cli=grok model=grok-composer-2.5-fast worker_names="lt-ada"

# heavy
cas__coordination action=spawn_workers count=1 isolate=true cli=grok model=grok-4.5 effort=high worker_names="hv-ada"
```
...
cas__coordination action=spawn_workers count=1 isolate=true cli=claude model=sonnet effort=high worker_names="sn-ada"

# frontier
cas__coordination action=spawn_workers count=1 isolate=true cli=claude model=opus effort=high worker_names="fr-ada"

# optional tiny Claude-only lane
cas__coordination action=spawn_workers count=1 isolate=true cli=claude model=haiku effort=low worker_names="hk-ada"
```
