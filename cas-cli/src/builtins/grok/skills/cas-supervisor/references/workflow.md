...
1. Spawn workers:
   ...
   **Heterogeneous team example** — Grok supervisor spawning Codex workers:
   ```
   # All Codex workers
   ...
   cas__coordination action=spawn_workers count=1 cli=codex model=gpt-5.5 effort=low worker_names="alice" isolate=true
   ```
