...
**If NORMAL** — try `mcp__cas__task action=mine` **once only**. If it responds, use the **MCP Workflow**. If it fails, use the **Fallback Workflow** immediately. Do NOT retry or attempt workarounds.
